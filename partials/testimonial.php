<section class="testimonial-section">
  <div class="container">
    <div class="testimonial-content">
      <!-- Client Information -->
      <div class="client-info" data-aos="zoom-in-right">
        <div class="client-avatar">
          <img src="assets/images/client-img.png" alt="Peter Moor - Student of Web Design" loading="lazy" />
        </div>
        <div class="client-details">
          <h3 class="client-name">Peter Moor</h3>
          <p class="client-title">Student of Web Design</p>
        </div>
        <div class="testimonial-indicators">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="6" viewBox="0 0 30 6" fill="none" aria-hidden="true">
      ...
      <!-- Client Testimonial -->
      <div class="client-testimonial" data-aos="flip-right">
        <div class="quote-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="28" viewBox="0 0 30 28" fill="none" aria-hidden="true">
